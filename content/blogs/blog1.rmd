...
## Deep dive on a few stocks 

Next, I have chosen a few stocks to analyze.
...
Below is a table with the monthly returns, min, max, median, and SD for each of the stocks.
